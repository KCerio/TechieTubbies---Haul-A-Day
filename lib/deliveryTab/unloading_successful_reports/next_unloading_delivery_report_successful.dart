...
import 'package:haul_a_day_mobile/deliveryTab/unloading_successful_reports/send_unloading_delivery_report_successful.dart';
...
class NextUnloadingDeliveryReportSuccessful extends StatefulWidget {
  ...
  _NextUnloadingDeliveryReportSuccessfulState createState() =>
      _NextUnloadingDeliveryReportSuccessfulState();
}



class _NextUnloadingDeliveryReportSuccessfulState extends State<NextUnloadingDeliveryReportSuccessful> {
  int _currentIndex = 1;
  int progress = 40;
...
//Widgets
  ...
  void nextPage(){
    if (_selectedDate != null && _selectedTime != null) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context)=>SendUnloadingSuccess(
