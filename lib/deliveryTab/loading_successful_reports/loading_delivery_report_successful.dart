...
import 'package:haul_a_day_mobile/deliveryTab/loading_successful_reports/next_loading_delivery_report_successful.dart';
...
class LoadingDeliveryReportSuccessful extends StatefulWidget {

  final LoadingDelivery loadingDelivery;
  final String orderId;

  const LoadingDeliveryReportSuccessful({Key? key,
    required this.loadingDelivery,
    required this.orderId}) : super(key: key);

  @override
  _LoadingDeliveryReportSuccessfulState createState() =>
      _LoadingDeliveryReportSuccessfulState();
}



class _LoadingDeliveryReportSuccessfulState extends State<LoadingDeliveryReportSuccessful> {
  int _currentIndex = 1;
  int progress = 0;
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(
                    '${widget.loadingDelivery.totalCartons} cartons loaded?',
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 14,
                    ),
  ...
  void moveToNextPage() {
    if (_selectedDate != null && _selectedTime != null) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context)=>NextLoadingDeliveryReportSuccessful(
